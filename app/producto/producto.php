<?php
    function getProducto() {
        if (isset($_POST['number1']) && isset($_POST['number2'])) {
            ...
            return "El resultado de la multiplicación es: ". ($number1 * $number2);
        }
    }
?>
<!DOCTYPE html>
...
<body>
    <div class="app">
        <h1 class="app--title" >Producto</h1>
        <form class="app__form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <input class="app--button" type="submit" value="Multiplicar">
        </form>
        <p class="app__result"><?php echo getProducto()?></p>
